...
urlpatterns = [
    ...
    path('update_cart_quantity/<int:variant_id>/<str:action>/', views.update_cart_quantity, name='update_cart_quantity'),
    ...
    path('orders/status/<int:order_id>/', views.get_order_status, name='get_order_status'),
    path('order-details/<int:order_id>/', views.order_fulldetail_view, name='order_fulldetail_view'),
    ...
    path('orders/return_item/<int:item_id>/', views.return_item, name='return_item'),
